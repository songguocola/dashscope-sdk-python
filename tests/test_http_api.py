...
class TestHttpRequest(MockRequestBase):
    ...
    def test_disable_data_inspection(self, http_server,
    ...
    def test_enable_data_inspection(self, http_server,
    ...
    def test_independent_model_sync_stream_request(self, http_server):
        resp = Generation.call(model=Generation.Models.qwen_turbo,
                               prompt='hello',
                               max_tokens=1024,
                               stream=True,
                               api_protocol='http',
    ...
    def test_send_receive_files(self, http_server):
        ...
        resp = HttpRequest.call(model=Generation.Models.qwen_turbo,
                                prompt='hello',
                                task_group='aigc',
