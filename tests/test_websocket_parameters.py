...
from tests.constants import (TEST_DISABLE_DATA_INSPECTION_REQUEST_ID,
                             TEST_ENABLE_DATA_INSPECTION_REQUEST_ID, TestTasks)
...
class TestWebSocketSyncRequest(BaseTestEnvironment):
    ...
    def test_disable_data_inspection(self, stream, http_server,
    ...
    def test_enable_data_inspection_by_env(self, stream, http_server,
