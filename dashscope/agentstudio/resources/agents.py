...
from dashscope.agentstudio.types.params import AgentCreateParams, AgentListParams, AgentUpdateParams, AgentVersionListParams
...
class Agents:
    ...
    def create(
        ...
        *,
        ...
        body = AgentCreateParams(
            ...
            mcp_servers=mcp_servers, skills=skills, metadata=metadata,
        ).to_dict()
        resp = self._client._transport.request("POST", _PATH_AGENTS, json=body)
    ...
    def retrieve(
        ...
        *,
        ...
        resp = self._client._transport.request("GET", f"{_PATH_AGENTS}/{agent_id}", params=params)
        return _coerce_agent(resp.data)
    ...
    def update(
        ...
        *,
        ...
        resp = self._client._transport.request("POST", f"{_PATH_AGENTS}/{agent_id}", json=body)
        return _coerce_agent(resp.data)

    def archive(self, agent_id: str) -> Agent:
        resp = self._client._transport.request("POST", f"{_PATH_AGENTS}/{agent_id}/archive")
        return _coerce_agent(resp.data)
    ...
    def list(
        ...
        *,
        ...
        params = AgentListParams(limit=limit, page=page, include_archived=include_archived).to_dict()
        resp = self._client._transport.request("GET", _PATH_AGENTS, params=params)
        return build_page(
            payload=resp.data,
    ...
    def list_versions(
        ...
        *,
        ...
        resp = self._client._transport.request(
            "GET", f"{_PATH_AGENTS}/{agent_id}/versions", params=params
        )
        return build_page(
            payload=resp.data,
...
class AsyncAgents:
    ...
    async def create(
        ...
        *,
        ...
        resp = await self._client._transport.request("POST", _PATH_AGENTS, json=body)
        return _coerce_agent(resp.data)
    ...
    async def retrieve(
        ...
        *,
        ...
        params = {"version": version} if version is not None else None
        resp = await self._client._transport.request("GET", f"{_PATH_AGENTS}/{agent_id}", params=params)
        return _coerce_agent(resp.data)
    ...
    async def update(
        ...
        *,
        ...
        resp = await self._client._transport.request("POST", f"{_PATH_AGENTS}/{agent_id}", json=body)
        return _coerce_agent(resp.data)

    async def archive(self, agent_id: str) -> Agent:
        resp = await self._client._transport.request("POST", f"{_PATH_AGENTS}/{agent_id}/archive")
        return _coerce_agent(resp.data)
    ...
    async def list(
        ...
        *,
        ...
        params = AgentListParams(limit=limit, page=page, include_archived=include_archived).to_dict()
        resp = await self._client._transport.request("GET", _PATH_AGENTS, params=params)
