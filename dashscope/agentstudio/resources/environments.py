...
from dashscope.agentstudio.types.params import EnvironmentCreateParams, EnvironmentListParams, EnvironmentUpdateParams
...
class Environments:
    ...
    def create(
        ...
        resp = self._client._transport.request(
            "POST", _PATH_ENVIRONMENTS, json=body, extra_headers=extra_headers
        )
        return _coerce_env(resp.data)

    def retrieve(self, environment_id: str) -> Environment:
        resp = self._client._transport.request("GET", f"{_PATH_ENVIRONMENTS}/{environment_id}")
        return _coerce_env(resp.data)
    ...
    def update(
        ...
        resp = self._client._transport.request("POST", f"{_PATH_ENVIRONMENTS}/{environment_id}", json=body)
        return _coerce_env(resp.data)
    ...
    def list(
        ...
        params = EnvironmentListParams(limit=limit, page=page, include_archived=include_archived).to_dict()
        resp = self._client._transport.request("GET", _PATH_ENVIRONMENTS, params=params)
        return build_page(
            payload=resp.data, item_factory=_coerce_env, request_id=resp.request_id,
            fetch_next=lambda nxt: self.list(
                limit=limit, page=nxt, include_archived=include_archived,
            ),
        )

    def archive(self, environment_id: str) -> Environment:
        resp = self._client._transport.request("POST", f"{_PATH_ENVIRONMENTS}/{environment_id}/archive")
        return _coerce_env(resp.data)

    def delete(self, environment_id: str) -> DeleteResponse:
        resp = self._client._transport.request("DELETE", f"{_PATH_ENVIRONMENTS}/{environment_id}")
...
class AsyncEnvironments:
    ...
    async def retrieve(self, environment_id: str) -> Environment:
        resp = await self._client._transport.request("GET", f"{_PATH_ENVIRONMENTS}/{environment_id}")
        return _coerce_env(resp.data)
    ...
    async def update(
        ...
        resp = await self._client._transport.request("POST", f"{_PATH_ENVIRONMENTS}/{environment_id}", json=body)
        return _coerce_env(resp.data)
    ...
    async def list(
        ...
        params = EnvironmentListParams(limit=limit, page=page, include_archived=include_archived).to_dict()
        resp = await self._client._transport.request("GET", _PATH_ENVIRONMENTS, params=params)
    ...
    async def archive(self, environment_id: str) -> Environment:
        resp = await self._client._transport.request("POST", f"{_PATH_ENVIRONMENTS}/{environment_id}/archive")
        return _coerce_env(resp.data)

    async def delete(self, environment_id: str) -> DeleteResponse:
        resp = await self._client._transport.request("DELETE", f"{_PATH_ENVIRONMENTS}/{environment_id}")
        return DeleteResponse(**resp.data)
