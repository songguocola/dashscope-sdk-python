...
class IOErrorWithCode(AgenticRLError):
    ...
    def __init__(self, message: str, error_code: int = 1800, path: Optional[str] = None,
...
class InputError(AgenticRLError):
    ...
    def __init__(self, message: str, error_code: int = 1100, field: Optional[str] = None):
...
class OutputError(AgenticRLError):
    ...
    def __init__(self, message: str, error_code: int = 1200, response: Optional[dict] = None):
        super().__init__(message, error_code)
        self.response = response


class ConnectionError(AgenticRLError):
    """Base class for connection-related errors"""
    def __init__(self, message: str, error_code: int = 1300, endpoint: Optional[str] = None):
        super().__init__(message, error_code)
        self.endpoint = endpoint


class OSSConnectionError(ConnectionError):
    """Raised when connecting to OSS storage service fails"""
    def __init__(self, message: str, error_code: int = 1310, endpoint: str = None):
        super().__init__(f"OSS connection failed: {message}", error_code, endpoint)


class OSSUploadError(ConnectionError):
    """Raised when file upload operation to OSS fails"""
    def __init__(self, message: str, error_code: int = 1320, endpoint: str = None, bucket: Optional[str] = None,
                 object_key: Optional[str] = None, file_size: Optional[int] = None):
...
class DeploymentError(AgenticRLError):
    ...
    def __init__(self, message: str, error_code: int = 1400, resource_id: Optional[str] = None):
        super().__init__(message, error_code)
...
class RegistrationError(DeploymentError):
    ...
    def __init__(self, message: str, error_code: int = 1410, resource_id: Optional[str] = None):
...
class FunctionLoadError(DeploymentError):
    ...
    def __init__(self, message: str, error_code: int = 1420, entity_id: str = None, error_log: Optional[str] = None):
        super().__init__(f"Function load failed: {message}", error_code, entity_id)
...
class FunctionLayerError(DeploymentError):
    ...
    def __init__(self, message: str, error_code: int = 1450, layer_name: str = None, error_log: Optional[str] = None):
        super().__init__(f"Function layer create failed: {message}", error_code, layer_name)
...
class InstanceWarmupError(DeploymentError):
    ...
    def __init__(self, message: str, error_code: int = 1430, instance_url: str = None, timeout: float = 0.0,
...
class InstanceQueryError(DeploymentError):
    ...
    def __init__(self, message: str, error_code: int = 1440, instance_id: str = None, query_attempts: int = 1):
        super().__init__(f"Instance query failed: {message}", error_code, instance_id)
...
class ValidationError(AgenticRLError):
    ...
    def __init__(self, message: str, error_code: int = 1500, invalid_data: Optional[dict] = None,
...
class ConfigurationError(ValidationError):
    ...
    def __init__(self, message: str, error_code: int = 1510, config_path: Optional[str] = None):
        super().__init__(message, error_code=error_code)
        self.config_path = config_path


class PermissionError(AgenticRLError):
    """Raised when an operation lacks required permissions"""
    def __init__(self, message: str, error_code: int = 1700, operation: str = None, resource: str = None):
