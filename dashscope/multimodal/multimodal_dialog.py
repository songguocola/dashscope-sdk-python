...
class MultiModalDialog:
    ...
    def __init__(
        ...
        This method initializes a new voice_chat session, setting up the necessary parameters
        to start interacting with the model.
        :param workspace_id: Customer workspace_id, primary workspace ID, optional field
        :param app_id: Application ID created in the console, used to determine which dialog system to use
        :param request_params: Request parameter collection
        :param url: (str) API URL address.
        :param multimodal_callback: (MultimodalCallback) Callback object for processing messages from server.
        :param api_key: (str) Application unique access key
        :param dialog_id: Dialog ID, if provided, continues the conversation with previous context
        :param model: Model
        """
    ...
    def start(self, dialog_id, enable_voice_detection=False, task_id=None):
        ...
        :param dialog_id: Context inheritance flag. Not needed for new dialogs.
               If inheriting previous dialog history, record and pass the previous dialog_id
        :param enable_voice_detection: Whether to enable voice detection, optional, default False
...
class _Request:
    ...
    def generate_request_to_response_json(
        ...
        :param direction_name: Command.
        :param dialog_id: Dialog ID.
        :param request_type: Interaction type the service should adopt, transcript means convert text to speech directly, prompt means send text to LLM for response  # noqa: E501
        :param text: Text.
    ...
    def _get_dash_request_header(self, action: str):
        ...
        :param action: ActionType DashScope protocol action, supports: run-task, continue-task, finish-task  # noqa: E501
        """
