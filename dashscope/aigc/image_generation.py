...
from dashscope.api_entities.dashscope_response import (GenerationResponse,
                                                       Message, DashScopeAPIResponse, ImageGenerationResponse)
from dashscope.client.base_api import BaseAioApi, BaseApi, BaseAsyncApi, BaseAsyncAioApi
...
class ImageGeneration(BaseApi, BaseAsyncApi):
        ...
        **kwargs
        ...
        if is_stream:
            if to_merge_incremental_output:
                ...
                return (ImageGenerationResponse.from_api_response(rsp)
                        for rsp in response)
        else:
    ...
    @classmethod
    def fetch(cls,
              task: Union[str, ImageGenerationResponse],
              api_key: str = None,
              workspace: str = None,
    ...
    @classmethod
    def _merge_generation_response(cls, response, n=1) -> Generator[ImageGenerationResponse, None, None]:
...
class AioImageGeneration(BaseAioApi, BaseAsyncAioApi):
    ...
    @classmethod
    async def _stream_responses(cls, response) -> AsyncGenerator[ImageGenerationResponse, None]:
    ...
    @classmethod
    async def _merge_generation_response(cls, response, n=1) -> AsyncGenerator[ImageGenerationResponse, None]:
