...
print(f'top_p: {assistant.top_p}, top_k: {assistant.top_k}, temperature: {assistant.temperature}, max_tokens: {assistant.max_tokens}, object: {assistant.object}')

# ==== test case 2: 新增和更新参数 =====
assistant = Assistants.update(assistant.id, top_k=9, top_p=0.4, temperature=0.9, max_tokens=1024)
